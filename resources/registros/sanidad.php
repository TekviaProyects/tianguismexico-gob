...
<!-- =====================________________				END crop-caceptacion		________________===================== -->
	...
	<div class="notoy">
		...
		<input type="text" id="a7" disabled>
		<br>
		<br>
	</div>
</div>
