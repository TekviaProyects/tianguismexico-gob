<div style="padding:2%;" class="">
  <h3 class="nomargin">Seleccione estado y municipio.</h3>
  <p> Donde se instalara su negocio.</p>
</div>
<div style="padding:2%;" class="row">
  <div class="col">
    <div class="form-group">
      <select class="form-control" name="mexico" id="mexico" onchange="mostrarInputs(this.value)">
    ...
    <div class="form-group">
      <select class="form-control" name="mexico" id="losmuni" onchange="mostrarValormu(this.value)">
